...
\subsubsection{StoreStatic}
静的なデータをメタデータに変換しMainNetに保存する。
...
引数にメタデータの名前となる文字列と、静的なデータを受け取る。
...
NavigatorはMainNetとSubNetの橋渡しを行うActorである。
MainNetを監視しており、Userから命令を受け取ったら、
